...
\begin{lemma}\label{bounded-classes}
  ...
  Then,
  \begin{enumerate}
    \item $\lb{\pp} = \set{M : M + \mathbf{1} \in \bounded{\pp}}$
    \item $\rb{\pp} = \set{M : \mathbf{1} + M \in \bounded{\pp}}$
    \item $\pp = \lb{\pp} \cap \rb{\pp} = \set{M : \mathbf{1} + M + \mathbf{1} \in \bounded{\pp}}$
  \end{enumerate}
\end{lemma}
...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    \item
          ...
          let $x, y \in M$ be any two points in $M + \mathbf{1}$.
    ...
    \item
          ...
          % \mathbf{1} + M + \mathbf{1} case
    \item
          We will show a triple inclusion.

          If $M \in \pp$, then by additivity,
          $\mathbf{1} + M \in \pp$ and $M + \mathbf{1} \in \pp$,
          and thus $M \in \lb{\pp} \cap \rb{\pp}$.

          If $M \in \lb{\pp} \cap \rb{\pp}$, then by~\cref{star-lemma},
          $\mathbf{1} + M + \mathbf{1} \in \bounded{\pp}$.

          If $\mathbf{1} + M + \mathbf{1} \in \bounded{\pp}$, then $M$ is a bounded
          subinterval of $\mathbf{1} + M + \mathbf{1}$, so $M \in \bounded{\pp}$.
  \end{enumerate}
\end{proof}
