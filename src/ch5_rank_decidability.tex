...
\begin{definition}
  ...
  We define the predicates $\mathbf{L}_{\alpha}$ and $\mathbf{R}_{\alpha}$ on $M$ as follows:

  \[
    \mathbf{L}_{\alpha} \ps{x} \in \lb{\ho{< \alpha}} \iff \bs{x}_{\alpha} \in \lb{\ho{< \alpha}}
  \]
  \[
    \mathbf{R}_{\alpha} \ps{x} \in \rb{\ho{< \alpha}} \iff \bs{x}_{\alpha} \in \rb{\ho{< \alpha}}
  \]
