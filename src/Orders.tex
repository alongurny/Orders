...
\begin{proof}
  ...
  Let $M$ be a scattered linear order of rank $\alpha$.

  Then $M = \sum_{i \in I} M_i$ where $\hrank{M_i} < \alpha$.
  By the induction hypothesis, we can find $N_i \equiv_n M_i$ with $\hrank{N_i} < f(n)$.

  Let $N = \sum_{i \in I} N_i$. Then $M \equiv_n N$.
